...
void SimulatedAnnealing2::initCodeLength(INIT_MODE mode)
{
    switch (mode)
    {
...
SimulatedAnnealing2::SimulatedAnnealing2(Config *config) : config(config), maxIter(config->maxIter), T(config->T), Rt(config->Rt), minMaxWidth(0), modRate(config->modRate)
{
    config = config;
...
void SimulatedAnnealing2::show_compress_ratio()
{
    cout << "Integers used: " << dl->getNumInts() << "/256" << endl;
    cout << "Non-compressed row width: " << nonCompressedWidth << endl;
    cout << "Initial row width: " << initMaxWidth << endl;
...
void SimulatedAnnealing2::show_history()
{
    cout << "=======================================================================================" << endl;
    cout << "======================================= History =======================================" << endl;
    cout << "=======================================================================================" << endl;
